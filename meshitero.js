...
var Meshitero = function () {
  ...
  this.requestGooglePlace = function (searchObj = {}) {
    ...
    return new Promise((resolve, reject) => {
      request({
        url: apiRequests.google_place + "nearbysearch/json",
        qs: request_params,
        json: true
      }, function (error, res, body) {
        if (error) {
